...
namespace GameStateManagement
{
    ...
    class GameplayScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            bgTexture = content.Load<Texture2D>("floor");

            player.LoadContent(content, "Stone Guy Finished", new Vector2(ScreenManager.windowSize.X / 2, ScreenManager.windowSize.Y - 40), new Vector2(32, 32));
            componentManager.LoadContent(ScreenManager.windowSize, content, player);
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            ...
            if (IsActive)
            {
                if (componentManager.gameOver)
                {
                    ...
                    componentManager.gameOver = false;
                }
                ...
                player.Update(gameTime, content, currentState, previousState, _currentState, _previousState, currentPadState, previousPadState, ScreenManager.windowSize);
                componentManager.Update(ScreenManager.windowSize, content, gameTime, player);
